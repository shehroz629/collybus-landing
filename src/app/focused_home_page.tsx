...
function HomeFocused() {
  ...
  <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-4 gap-4 opacity-80">
          {/* Existing logos */}
          <a href="https://www.kc.com/" target="_blank" rel="noopener noreferrer" className="rounded-lg bg-white/5 border border-white/10 flex items-center justify-center h-20 md:h-24 p-3">
          ...
          <a href="https://www.binance.com/" target="_blank" rel="noopener noreferrer" className="rounded-lg bg-white/5 border border-white/10 flex items-center justify-center h-15 md:h-20 p-3">
