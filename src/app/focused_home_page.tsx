    ...
    <div className="absolute inset-0 pointer-events-none overflow-hidden">
      ...
      <div className="pointer-events-none">
        ...
        <div className="absolute left-0 right-0 w-full" style={{ top: "4%" }}>
          <iframe
            src="https://s.tradingview.com/embed-widget/ticker-tape/?locale=en#%7B%22symbols%22%3A%5B%7B%22proName%22%3A%22BINANCE%3ABTCUSDT%22%2C%22title%22%3A%22BTC%2FUSDT%22%7D%2C%7B%22proName%22%3A%22BINANCE%3AETHUSDT%22%2C%22title%22%3A%22ETH%2FUSDT%22%7D%2C%7B%22proName%22%3A%22BINANCE%3ASOLUSDT%22%2C%22title%22%3A%22SOL%2FUSDT%22%7D%2C%7B%22proName%22%3A%22BINANCE%3ADOGEUSDT%22%2C%22title%22%3A%22DOGE%2FUSDT%22%7D%2C%7B%22proName%22%3A%22BINANCE%3ASHIBUSDT%22%2C%22title%22%3A%22SHIB%2FUSDT%22%7D%2C%7B%22proName%22%3A%22BINANCE%3AWLDUSDT%22%2C%22title%22%3A%22WLD%2FUSDT%22%7D%2C%7B%22proName%22%3A%22BINANCE%3ALTCUSDT%22%2C%22title%22%3A%22LTC%2FUSDT%22%7D%2C%7B%22proName%22%3A%22BINANCE%3ARPLUSDT%22%2C%22title%22%3A%22RPL%2FUSDT%22%7D%2C%7B%22proName%22%3A%22BINANCE%3ASUIUSDT%22%2C%22title%22%3A%22SUI%2FUSDT%22%7D%2C%7B%22proName%22%3A%22BINANCE%3AUSDTUSD%22%2C%22title%22%3A%22USDT%2FUSD%22%7D%5D%2C%22showSymbolLogo%22%3Atrue%2C%22colorTheme%22%3A%22dark%22%2C%22isTransparent%22%3Atrue%2C%22displayMode%22%3A%22adaptive%22%2C%22locale%22%3A%22en%22%7D"
        ...
        {/* TradingView ticker at bottom (dynamic) */}
...
function HomeFocused() {
  ...
  <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-4 gap-4 opacity-80">
          ...
          <a href="https://www.bitmex.com/" target="_blank" rel="noopener noreferrer" className="rounded-lg bg-white/5 border border-white/10 flex items-center justify-center h-15 md:h-20 p-3">
            <img src="/images/bitmex-logo-new.png" alt="BitMEX" className="max-h-full w-auto object-contain" style={{height:'1.5rem'}} />
          </a>
          ...
          <a href="https://www.kraken.com/" target="_blank" rel="noopener noreferrer" className="rounded-lg bg-white/5 border border-white/10 flex items-center justify-center h-15 md:h-20 p-3">
            <img src="https://cdn.worldvectorlogo.com/logos/kraken-4.svg" style={{height:'2.0rem'}} alt="Kraken" className="max-h-full w-auto object-contain" />
          </a>
          {/* BitGo logo */}
          <a href="https://www.bitgo.com/" target="_blank" rel="noopener noreferrer" className="rounded-lg bg-white/5 border border-white/10 flex items-center justify-center h-15 md:h-20 p-3">
            <img src="/images/bitgo-logo-new.png" alt="BitGo" className="max-h-full w-auto object-contain" style={{height:'2.5rem'}} />
          </a>
        </div>
      </Section>
